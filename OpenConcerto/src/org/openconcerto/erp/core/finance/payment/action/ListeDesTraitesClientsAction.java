...
public class ListeDesTraitesClientsAction extends CreateFrameAbstractAction {

    public ListeDesTraitesClientsAction() {
        super();
        this.putValue(Action.NAME, "Liste des traites, virements clients");
    }

    public JFrame createFrame() {
        SQLTable table = Configuration.getInstance().getBase().getTable("ENCAISSER_MONTANT");
        ...
        wPrev = wPrev.and(new Where(elt.getTable().getField("ID_ECHEANCE_CLIENT"), ">", 1));
        frame.getPanel().setRequest(ListSQLRequest.copy(elt.getListRequest(), wPrev));
