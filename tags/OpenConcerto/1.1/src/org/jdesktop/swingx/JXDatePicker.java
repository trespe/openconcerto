/*
 * $Id: JXDatePicker.java,v 1.19 2005/11/22 05:05:44 dmouse Exp $
 *
...
public class JXDatePicker extends JComponent {
    ...
    public void setFormats(DateFormat[] formats) {
        this._dateField.setFormatterFactory(new DefaultFormatterFactory(
    ...
    public DateFormat[] getFormats() {
        ...
        AbstractFormatterFactory factory = this._dateField.getFormatterFactory();
        if (factory != null) {
            AbstractFormatter formatter = factory.getFormatter(this._dateField);
    ...
    public void setMonthView(JXMonthView monthView) {
        ...
        firePropertyChange(MONTH_VIEW, oldMonthView, this._monthView);
    }
    ...
    public void setLinkPanel(JPanel linkPanel) {
        ...
        firePropertyChange(LINK_PANEL, oldLinkPanel, this._linkPanel);
    }
    ...
    public void setEditor(JFormattedTextField editor) {
        ...
        firePropertyChange(EDITOR, oldEditor, this._dateField);
    }
    ...
    public void setEditable(boolean value) {
        ...
        this.editable = value;
        firePropertyChange("editable", oldEditable, this.editable);
