...
public class ListeDesChequesFournisseursAction extends CreateFrameAbstractAction {

    public ListeDesChequesFournisseursAction() {
        super();
        this.putValue(Action.NAME, "Chèques aux fournisseurs");
    }

    public JFrame createFrame() {

        IListFrame frame = new IListFrame(new ListeAddPanel(Configuration.getInstance().getDirectory().getElement("CHEQUE_FOURNISSEUR")) {
