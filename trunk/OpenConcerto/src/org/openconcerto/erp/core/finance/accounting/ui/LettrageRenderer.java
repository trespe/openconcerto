...
public class LettrageRenderer extends DefaultTableCellRenderer {
    ...
    private static LettrageRenderer instance = null;

    public synchronized static LettrageRenderer getInstance() {
        if (instance == null) {
            instance = new LettrageRenderer();
        }
        return instance;
    }

    private LettrageRenderer() {
        super();
    }
    ...
    public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
        ...
        if (!isSelected) {
            ...
            final String string = ecritureRow.getString("LETTRAGE");
            if (string != null && string.trim().length() > 0) {
                this.setBackground(couleurEcritureLettree);
            }
        }
